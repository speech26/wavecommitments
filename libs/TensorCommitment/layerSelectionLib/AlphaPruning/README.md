...
## Installation
Environment setup instructions are documented in the parent library guide: [layerSelectionLib README](../README.md#installation).
...
## Acknowledgement
Please check the original project page for AlphaPruning's original codebase for the reference (https://github.com/haiquanlu/AlphaPruning). Their repository is build upon the [Wanda](https://github.com/locuslab/wanda/tree/main) and [TempBalance](https://github.com/YefanZhou/TempBalance/tree/main) repository.
